 ...
 */
chip::System::PacketBufferHandle encodeGeneralCommissioningClusterSetFabricCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, char * fabricId, char * fabricSecret, uint64_t breadcrumb, uint32_t timeoutMs);
 ...
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterAddThreadNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, char * operationalDataset, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an AddWiFiNetwork command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterAddWiFiNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, char * ssid, char * credentials, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an DisableNetwork command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterDisableNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, char * networkID, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an EnableNetwork command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterEnableNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, char * networkID, uint64_t breadcrumb, uint32_t timeoutMs);
 ...
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterRemoveNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, char * networkID, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an ScanNetworks command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterScanNetworksCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, char * ssid, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an UpdateThreadNetwork command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterUpdateThreadNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, char * operationalDataset, uint64_t breadcrumb, uint32_t timeoutMs);

/**
 * @brief
 *    Encode an UpdateWiFiNetwork command for Network Commissioning server into buffer including the APS frame
 */
chip::System::PacketBufferHandle encodeNetworkCommissioningClusterUpdateWiFiNetworkCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, char * ssid, char * credentials, uint64_t breadcrumb, uint32_t timeoutMs);
