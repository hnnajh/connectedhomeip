 ...
 * Command ArmFailSafe
 */
PacketBufferHandle encodeGeneralCommissioningClusterArmFailSafeCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t expiryLengthSeconds, uint64_t breadcrumb, uint32_t timeoutMs)
{
...
PacketBufferHandle encodeGeneralCommissioningClusterCommissioningCompleteCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("CommissioningComplete", GENERAL_COMMISSIONING_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_COMMISSIONING_COMPLETE_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
 ...
 * Command SetFabric
 */
PacketBufferHandle encodeGeneralCommissioningClusterSetFabricCommand(uint8_t seqNum, EndpointId destinationEndpoint, char * fabricId, char * fabricSecret, uint64_t breadcrumb, uint32_t timeoutMs)
{
...
PacketBufferHandle encodeGeneralCommissioningClusterWriteBreadcrumbAttribute(uint8_t seqNum, EndpointId destinationEndpoint, uint64_t breadcrumb)
{
 ...
 */
PacketBufferHandle encodeNetworkCommissioningClusterAddThreadNetworkCommand(uint8_t seqNum, EndpointId destinationEndpoint, char * operationalDataset, uint64_t breadcrumb, uint32_t timeoutMs)
{
 ...
 */
PacketBufferHandle encodeNetworkCommissioningClusterAddWiFiNetworkCommand(uint8_t seqNum, EndpointId destinationEndpoint, char * ssid, char * credentials, uint64_t breadcrumb, uint32_t timeoutMs)
{
 ...
 */
PacketBufferHandle encodeNetworkCommissioningClusterDisableNetworkCommand(uint8_t seqNum, EndpointId destinationEndpoint, char * networkID, uint64_t breadcrumb, uint32_t timeoutMs)
{
 ...
 */
PacketBufferHandle encodeNetworkCommissioningClusterEnableNetworkCommand(uint8_t seqNum, EndpointId destinationEndpoint, char * networkID, uint64_t breadcrumb, uint32_t timeoutMs)
{
 ...
 */
PacketBufferHandle encodeNetworkCommissioningClusterGetLastNetworkCommissioningResultCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint32_t timeoutMs)
{
 ...
 */
PacketBufferHandle encodeNetworkCommissioningClusterRemoveNetworkCommand(uint8_t seqNum, EndpointId destinationEndpoint, char * networkID, uint64_t breadcrumb, uint32_t timeoutMs)
{
 ...
 */
PacketBufferHandle encodeNetworkCommissioningClusterScanNetworksCommand(uint8_t seqNum, EndpointId destinationEndpoint, char * ssid, uint64_t breadcrumb, uint32_t timeoutMs)
{
 ...
 */
PacketBufferHandle encodeNetworkCommissioningClusterUpdateThreadNetworkCommand(uint8_t seqNum, EndpointId destinationEndpoint, char * operationalDataset, uint64_t breadcrumb, uint32_t timeoutMs)
{
 ...
 */
PacketBufferHandle encodeNetworkCommissioningClusterUpdateWiFiNetworkCommand(uint8_t seqNum, EndpointId destinationEndpoint, char * ssid, char * credentials, uint64_t breadcrumb, uint32_t timeoutMs)
{
...
PacketBufferHandle encodeThermostatClusterClearWeeklyScheduleCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ClearWeeklySchedule", THERMOSTAT_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_CLEAR_WEEKLY_SCHEDULE_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
...
PacketBufferHandle encodeThermostatClusterGetRelayStatusLogCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("GetRelayStatusLog", THERMOSTAT_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_GET_RELAY_STATUS_LOG_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
 ...
 */
PacketBufferHandle encodeThermostatClusterGetWeeklyScheduleCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t daysToReturn, uint8_t modeToReturn)
{
 ...
 */
PacketBufferHandle encodeThermostatClusterSetWeeklyScheduleCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t numberOfTransitionsForSequence, uint8_t dayOfWeekForSequence, uint8_t modeForSequence, uint8_t payload)
{
 ...
 */
PacketBufferHandle encodeThermostatClusterSetpointRaiseLowerCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t mode, int8_t amount)
{
...
PacketBufferHandle encodeThermostatClusterConfigureLocalTemperatureAttribute(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t minInterval, uint16_t maxInterval, int16_t change)
{
...
PacketBufferHandle encodeThermostatClusterWriteOccupiedCoolingSetpointAttribute(uint8_t seqNum, EndpointId destinationEndpoint, int16_t occupiedCoolingSetpoint)
{
...
PacketBufferHandle encodeThermostatClusterWriteOccupiedHeatingSetpointAttribute(uint8_t seqNum, EndpointId destinationEndpoint, int16_t occupiedHeatingSetpoint)
{
...
PacketBufferHandle encodeThermostatClusterWriteControlSequenceOfOperationAttribute(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t controlSequenceOfOperation)
{
...
PacketBufferHandle encodeThermostatClusterWriteSystemModeAttribute(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t systemMode)
{
