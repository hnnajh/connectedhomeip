...
#define GENERATED_CLUSTERS { \
  ...
  { 0xF001, ZAP_ATTRIBUTE_INDEX(94), 2, 4, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Media Playback (server) */ \
  { 0xF002, ZAP_ATTRIBUTE_INDEX(96), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1, Cluster: Content Launch (server) */ \
  { 0x0000, ZAP_ATTRIBUTE_INDEX(97), 3, 4, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 2, Cluster: Basic (server) */ \
  { 0x0006, ZAP_ATTRIBUTE_INDEX(100), 2, 3, ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), chipFuncArrayOnOffServer }, /* Endpoint: 2, Cluster: On/off (server) */ \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 15, 415 }, \
  { ZAP_CLUSTER_INDEX(15), 2, 7 }, \
}
